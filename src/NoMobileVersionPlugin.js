let NMVP = {
  ...
  messageTop: 'Ой-ой!',
  messageBottom: 'Кажется этот сайт предназначен только для просмотра с ПК',
  theme: 'dark',
  themeCustom_BG: '',
  themeCustom_TEXT: '',
  smileVisible: true,
...
function checkDevice() {
  ...
  if (
    ...
    // Check whether you have accessed the site from a mobile device
    itMobile(); // if mobile
  } else {
    itPC(); // if pc
  }
...
function setPageSettings() {
  ...
  document.title = NMVP.messageTop; // add block message
}
